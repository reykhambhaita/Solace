  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "flex w-fit items-center justify-between gap-2 rounded-lg border bg-background/50 backdrop-blur-sm",
        "px-3 py-2 text-sm whitespace-nowrap shadow-sm transition-all duration-200",
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "rounded-xl border border-border/50 shadow-xl shadow-black/10 dark:shadow-black/30",
